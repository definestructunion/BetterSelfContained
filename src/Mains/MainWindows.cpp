#include "../Impl/ImplWindows.hpp"
#include "../coreclrhost.h"

#include <iostream>
#define LOG(X) std::cout << X << std::endl

// TODO: change to "int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)" on release
...
//int main() {
    ...
    HMODULE coreClr = loadLibrary(coreClrPath);
